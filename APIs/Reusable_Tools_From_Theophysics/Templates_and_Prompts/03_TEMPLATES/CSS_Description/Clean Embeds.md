...
tags:
  - CSS
use: Make your embeds look like a note itself
---
## What this does?
Embed have title, link, padding and margins. This CSS removes all of those stuff to make it really look like the same note.

You don't need to add the CSSclasses property for this to work.


## Example:
- [[00_SYSTEM/03_TEMPLATES/CSS_Description/Clean Embeds|Clean Embeds]]
![[12591.png]]


## Source
- [Can someone give me the css snippet to do that ? : ObsidianMD (reddit.com)](https://www.reddit.com/r/ObsidianMD/comments/rm3viu/can_someone_give_me_the_css_snippet_to_do_that/)
