...
tags:
  - CSS
use: Add Beautiful gradient colors to headings, texts
---
## What this does?
It *adds gradient colors* to all of the vault. I actually stripped this from [Royal Velvet Theme](https://github.com/caro401/royal-velvet). And ***I’m not a pro at CSS***, so it might conflict with the theme you are using.
