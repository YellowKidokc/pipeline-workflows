#!/usr/bin/env python3
"""Health check for P03_lightfm"""
import json, importlib, sys
from pathlib import Path

def check():
    status = {'engine': 'P03', 'name': 'lightfm', 'checks': {}}

    # Check library import
    try:
        importlib.import_module('lightfm')
        status['checks']['library_lightfm'] = 'OK'
    except ImportError:
        status['checks']['library_lightfm'] = 'MISSING'
