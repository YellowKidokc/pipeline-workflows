#!/usr/bin/env python3
"""Health check for P01_implicit"""
import json, importlib, sys
from pathlib import Path

def check():
    status = {'engine': 'P01', 'name': 'implicit', 'checks': {}}

    # Check library import
    try:
        importlib.import_module('implicit')
        status['checks']['library_implicit'] = 'OK'
    except ImportError:
        status['checks']['library_implicit'] = 'MISSING'
