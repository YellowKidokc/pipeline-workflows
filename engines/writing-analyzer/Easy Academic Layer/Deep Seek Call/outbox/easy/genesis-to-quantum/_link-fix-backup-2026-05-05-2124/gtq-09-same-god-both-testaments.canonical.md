...
---
claims:
  - "The Old Testament and New Testament describe the same God, operating under different conditions, governed by a single coherence equation: dC/dt = O·G(1-C) - S·C."
  - "The apparent harshness of the Old Testament is explained by the Bronze Age context of 50% child mortality, blood feuds, and child sacrifice, not by a change in God's character."
  - "The Mosaic Law's innovations (Cities of Refuge, female inheritance, slave protection) were unprecedented acts of mercy in a brutal world, not arbitrary cruelty."
  - "The pace of progressive revelation is set by the receivers' capacity to understand; 'love your enemies' is calculus that required 15 centuries of foundational teaching."
  - "The Cross is the convergence point where justice (S·C), mercy (G), and free will (O) operate simultaneously in a single act by a single Person."
  - "The Holy Spirit's distribution at Pentecost changed the operating conditions, shifting adversarial access from direct personal attack to structural/systemic attack."
  - "Modern Western culture is structurally isomorphic to Canaanite culture, running the same spiritual architecture (child sacrifice, temple prostitution, debt slavery) at industrial scale."
domains:
  Theology: 35
  History/Culture: 20
  Physics: 15
...
# The God of Genesis and the God of Revelation Are the Same Equation

**Debate**

**Opening Note**

Same God, both testaments. The Old Testament God who floods the earth and the New Testament God who dies on a cross are the same Being. They just operate in different modes of the same equation. We are not softening the Old Testament. We are showing that the math requires both modes.

This is the article I have been most afraid to write. Not because the answer is unclear — the answer has been sitting in plain view for sixteen centuries. I have been afraid because the question is one of the most painful in Christianity, and most of the answers people give have made the pain worse. I am not going to tell you the hard passages are not hard. They are hard. I am going to do something else first. I am going to take you to 1400 BC and make you stand in the dirt for a few minutes, because every honest answer to the Old Testament/New Testament problem has to start there. Every dishonest one starts in 2026 and reasons backward.
...
When someone asks the Old Testament/New Testament question seriously, they tend to get one of four answers. Each one captures something true. None of them holds the whole thing.
...
Earlier in this series we wrote down the equation that governs how a soul moves into or away from coherence (alignment) with God. It came up first in Article 03, where it dissolved the Calvinist-Arminian fight. It came up again in Article 04, where the lifespan data in Genesis turned out to fit it at R² = 0.888. Here it is again:

**Coherence Equation**

$$\frac{dC}{dt} = O \cdot G(1-C) - S \cdot C$$

This equation means: the rate of change in your alignment with God equals your openness times grace times your remaining potential, minus the decay caused by entropy.

C is coherence — your alignment with God, ranging from total alignment at 1 to total decoherence (disconnection) at 0. The right-hand side has three terms doing three different things. O is your openness, the human variable, the willingness to receive. G is grace, the divine input, the energy that flows from God into the system. S is entropy (disorder), the decay term, the cost of living in a fallen universe where coherence has to be actively maintained.

Now look at what those three terms *are* in moral language.

| Equation Term | Moral Meaning | What It Does |
|---|---|---|
| **S · C** | **Justice** | Structural fact that coherence loss has consequences. Sin damages the coherence state the way friction degrades a moving part. The "wrath of God" language in the prophets describes this term operating in real time. |
| **G** | **Mercy** | The input that *must* be present for the equation to go anywhere except down. Without G, the equation reduces to dC/dt = -S·C, pure exponential decay. The system dies. Grace was never withdrawn — not once, not in the flood, not in the conquest, not in the exile. |
| **O** | **Free Will** | The human variable. The growth term is *multiplicative*: O × G × (1-C). Both O and G must be nonzero for growth to occur. God provides G. The person provides O. Neither alone is sufficient. Love that cannot be refused is not love. |
...
The answer: the prescription and the execution are two different things, and the law was deliberately designed so that the second almost never followed the first. Capital cases required two or three witnesses, no exceptions. Circumstantial evidence was inadmissible. False testimony in a capital case carried the same penalty as the crime. The Mishnah says a Sanhedrin (Jewish court) that executed even one person in seventy years was called a "bloody court." The stoning provisions functioned as boundary markers, not quotas.

And the historical context matters. The world *before* "an eye for an eye" was a world of escalating blood feuds. *Lex talionis* (the law of retaliation) is the first de-escalation law in recorded human history. It is not a permission to take an eye. It is a *limit* on how much you are allowed to take.

There is one more thing the Mosaic code did that nobody else in the region did. It introduced **Cities of Refuge** — six cities where someone who had killed accidentally could flee and be safe until a trial could establish whether the killing was murder or manslaughter. A trial. To distinguish *intent*. The concept now called *mens rea* (guilty mind) that sits at the foundation of every modern Western legal system. Introduced 3,400 years ago, in a world where the alternative was the Blood Redeemer arriving at your door and not asking questions.
...
**Justice is there.** Someone has to pay for the accumulated decoherence of the species. The cost is not symbolic. The S·C term gets balanced to zero by an external input that absorbs the entire accumulated load. Justice is not waived. Justice is *paid*.
...
In the **diagnostic phase**, the doctor's job is to tell the patient the truth about what is wrong. This is the phase where the language is hard. "Your liver is failing." "The cancer has metastasized." The Old Testament is God in diagnostic mode. The S·C term is loud in the narrative because S is what has to be named before it can be addressed.
...
Every hard Old Testament passage is the logical consequence of a God who refuses to drop justice, refuses to withhold mercy, and refuses to override freedom — all at the same time, for fifteen centuries, while parenting a species that could not yet understand the word *love*.

That sentence is the entire article. Everything above is commentary on it. If the framework is right, the Old Testament/New Testament problem is not a contradiction that requires faith to ignore. It is a single equation operating across two phases of one curriculum, taught by one Person, aimed at one outcome. The Person did not change. The vocabulary did. The students finally caught up.

---

## What You Just Read

The Old Testament and the New Testament have one author. We have shown why with one equation: dC/dt = O·G(1-C) - S·C. The same three terms — justice, mercy, free will — that hold the framework together at the level of physics turn out to be the same three terms that hold theology together at the level of moral history.
...
**"The math says so."** The math does not say the OT and NT have one author. The math shows that a specific equation with three terms can hold three constraints simultaneously. The inference requires several additional steps, including the identification of justice with S·C, mercy with G, and free will with O. Those identifications are defensible but they are not derivations.
...
## Tangent 09-A: Regime-Dependent Theology
