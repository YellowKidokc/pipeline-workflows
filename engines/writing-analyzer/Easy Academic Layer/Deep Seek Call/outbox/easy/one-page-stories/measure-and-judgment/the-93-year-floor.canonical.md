...
claims:
  ...
  - "The exponential decay model independently finds an asymptotic floor at 93 years, matching Psalm 90:10 (70-80 years) and modern global average (73 years)."
  - "The post-Flood lifespan drop is caused by generational entropy—compounding degradation in the information channel between humans and the Logos."
  - "The χ vacuum field (grace floor) prevents lifespan from decaying to zero, maintaining a minimum coherence that thermodynamics cannot breach."
  - "The serpent's attack in Genesis 3:1 introduced heritable noise into the informational channel, producing the exponential decay curve."
  - "Moses in Psalm 90:10 identified the same lifespan floor empirically, without mathematical models, three thousand years before modern data."
...
When you plot these lifespans against generation number and fit an exponential decay model (a mathematical formula that describes how something shrinks over time), you get this:

$$L(n) = L_0 \cdot e^{-n/\tau} + L_{\text{floor}}$$

L(n) is the lifespan at generation *n* — how long people lived.

L₀ is the pre-decay baseline — the starting point before the decay.

e^(-n/τ) is the exponential decay — like compounding entropy (disorder) across generations.

τ is the decay timescale — about 3–4 generations for lifespan to drop to about 37% of L₀.

L_floor is the asymptotic floor — **the minimum lifespan that entropy cannot break through**.
