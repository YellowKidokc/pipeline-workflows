...
---
claims:
  - "The Lean 4 theorem prover has formally verified 287 theorems showing the internal structural consistency of Theophysics, with zero logical gaps."
  ...
  - "Seven independent lines of inquiry (logic, morality, information, consciousness, experience, mathematics, and physics) all converge on the same God-shaped structure, and no alternative explains this convergence better."
  - "Corrupted systems cannot self-repair using only corrupted resources — external intervention is required, as proved by the sign conversion discipline."
  - "The Maxwell/Trinity isomorphism shows that quaternion electromagnetics and the relational Trinity share the same structural form under a five-condition test, while five false positives (including Modalism and Heaviside EM) are rejected."
  - "The framework names its own gaps: 5 formal gaps that could be closed with more Lean code, and 5 specification gaps that require domain judgment or historical evidence."
  - "The hit rate discipline proves an 80% success rate (8 hits out of 10 attempts) with a closed denominator — no hidden failures, and the 90% claim is formally blocked."
domains:
  Formal Logic/Mathematics: 30
  Theology: 25
  Physics: 15
  Information Theory: 10
  Philosophy: 10
  Empirical/Historical: 5
...
| 71 | L6 | BridgeScoreDiscipline.lean | law7_frame_locked_score_fails_R_gate | Frame locked → R gate = 0 | rfl | Rejection