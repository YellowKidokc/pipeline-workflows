...
---
claims:
  - "Fiat currency (money not backed by gold) violates the First Law of Thermodynamics because it creates money from nothing, which is like creating energy from nothing."
  - "The 1971 Nixon Shock, which ended the gold standard, was a phase transition that removed the conservation constraint on money, leading to measurable inflation and inequality."
  - "Every fiat currency in history has eventually failed, with an average lifespan of about 27 years, because the conservation violation accumulates waste heat (inflation) that overwhelms institutional trust."
  - "Fiat currency is not just bad policy; it is a structural violation of divine moral order, as shown by biblical prohibitions on false measures and unearned gain."
  - "The Cantillon Effect (those closest to money creation benefit first) is the economic equivalent of local entropy decrease at the cost of global entropy increase."
  - "Reversing the degradation requires restoring a conservation constraint, like a gold standard, not printing more money."
  - "The mapping between physics and economics is a well-structured analogy, not a true isomorphism, because energy conservation is a fundamental law while monetary conservation was an institutional choice."
domains:
  Physics: 30
  Economics: 30
  Theology: 20
...
This equation means: In a closed system, the total amount of energy stays the same. You can't get something for nothing.
...
This equation means: Under fiat money systems, the total amount of money changes. It's not conserved.
