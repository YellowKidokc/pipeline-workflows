...
---
claims:
  - "The Second Law of Thermodynamics proves that a closed system cannot reduce its own entropy, making self-salvation thermodynamically impossible."
  - "Grace is negentropy (negative entropy) injected from outside the system, and cannot be earned, rewarded, or generated internally."
  - "The Cross paid the Landauer cost (the minimum energy needed to erase one bit of information) for the full restoration of moral order in human history."
  - "The complete equation dC/dt = O·G(1-C) - S·C + G·δ(t - t_init) resolves the Calvinist-Arminian debate: irresistible grace is a single initiation event, after which free will (O) operates genuinely."
  - "A civilization that systematically closes its openness (O) to grace is on a thermodynamic trajectory toward decay, not a spiritual problem that will resolve itself."
  - "The admission of weakness (O fully open) allows the growth term to operate at full capacity, resolving the paradox of 2 Corinthians 12:10."
  - "The decay term always wins alone; grace must come from outside the system because the Second Law forbids internal entropy reduction."
domains:
  Thermodynamics: 30
  Theology: 30
  Mathematics: 15
...
# Why Grace Has to Come from *Outside*
...
## Section I: What the Second Law Actually Says
...
## Section II: The Equation That Makes This Precise
...
## Section III: Why You Can't Fix It from Inside
...
## Section IV: The Calvinism Problem in the Equation
...
**The Complete Equation (With Initiation)**
$$\frac{dC}{dt} = O \cdot G(1-C) - S \cdot C + G \cdot \delta(t - t_{\text{init}})$$
...
## Section V: What Grace Actually Is in the Physics
...
## Section VI: The Cross as Thermodynamic Necessity
...
## Section VII: What This Means for the Three Pathways
...
## Section VIII: The Hardest Implication
...
[HomeGenesis to Quantum](genesis-quantum-event.html) CurrentWhy Grace Has to Come from Outside [RelatedThe Salvation Algorithm](salvation-algorithm.html) [RelatedHeaven & Hell as Attractor States](heaven-hell-attractor-states.html) [RelatedSalvation as Phase Transition](salvation-phase-transition.html) [GTQ SeriesFree Will in Two Frames](genesis-quantum-event.html)
