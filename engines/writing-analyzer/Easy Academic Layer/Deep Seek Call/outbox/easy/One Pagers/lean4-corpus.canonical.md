...
---
claims:
  - "The Lean 4 theorem prover has formally verified 287 theorems with zero gaps, proving the internal structural consistency of the Theophysics framework."
  - "The Cross is the unique configuration that satisfies all five conditions for perfect repair (justice, mercy, freedom, relation, and record) — every alternative fails at least one condition."
  - "Seven independent lines of inquiry (logic, morality, information, consciousness, experience, mathematics, and theology) all converge on the same God-shaped structure, and no alternative explains this convergence better."
  - "Corrupted systems cannot self-repair; external intervention (the Christ Operator) is required to convert negative moral burdens to positive coherence while preserving the source record."
  - "The Maxwell/Trinity isomorphism proves a formal structural equivalence between quaternion electromagnetics and the relational Trinity, passing all five test conditions while five false positives are rejected."
  - "The framework names its own gaps: 5 formal gaps that could be closed with more Lean code, and 5 specification gaps that require domain judgment, empirical data, or historical evidence."
  - "The hit rate discipline shows 8 hits out of 10 attempts (80%), with a closed denominator — no hidden failures, and the 90% claim is formally blocked."
domains:
...
| 33 | L3 | BridgeMatrix.lean | full_R_gate_required | R = 0 kills χ even if everything else is 1. Gate is non-negotiable. | simp | Proved |
...
| 71 | L6 | BridgeScoreDiscipline.lean | law7_frame_locked_score_fails_R_gate | Frame locked → R gate = 0 | rfl