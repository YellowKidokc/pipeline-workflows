...
---
claims:
  - "Loneliness is as deadly as smoking fifteen cigarettes a day, with social isolation increasing premature death risk by 26% (Surgeon General, 2023)."
  - "Technology has created 'connection without commitment' — AI now writes dating messages and millions use AI girlfriends, while Tinder usage dropped 30% from its peak."
  - "The percentage of adults with no close friends rose from 3% in 1990 to 12% in 2025, and 27% of young men aged 18-30 haven't had sex in the past year."
  - "The four-generation family wisdom 'Find a good woman. Work. Stay' was once enforced by external constraints, but now must be chosen voluntarily — which is harder but more meaningful."
  - "Showing up physically and regularly in the same place (like a church or discussion group) is the only way to rebuild trust and real connection — algorithms cannot produce belonging."
  - "Staying is a choice that must be made daily against infinite options — closing the door on searching for something better is the essential act of building a real life."
  - "Local 'coherence bubbles' form when people voluntarily adopt constraints — this is how physical systems re-order, and it's how social restoration begins."
domains:
  Sociology: 30
...
[**Previous](MDA-031-jacob-1998.html) [Series Index](../index.html)
