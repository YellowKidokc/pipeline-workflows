...
---
claims:
  - "The removal of multiple social constraints in the 1970s (no-fault divorce, birth control, television saturation) caused a phase transition in American society, not gradual decline."
  - "By 1974, trust in government collapsed from 77% (1964) to 36%, and church attendance dropped from 55% (1958) to 40%, showing structural removal of moral scaffolding."
  - "The character Thomas Lowe inherits a world where 'find a good woman, work, stay' is meaningless because the environment no longer enforces those virtues."
  - "Television saturation (6+ hours/day by 1974) replaced shared family experience with fragmented input, eroding patience, faithfulness, and self-control."
  - "The decoupling of sex from pregnancy via the Pill removed the biological constraint that had shaped every prior generation's moral choices."
  - "Thomas's divorce in 1985 is 'no-fault, no drama, just paperwork' — showing that commitment became optional when consequences were removed."
  - "The system crossed a critical threshold (Pc) where constraint pressure fell below the level needed for social coherence, making decline feel abrupt and total."
domains:
  History/Culture: 35
  Sociology: 25
  Physics: 15
...
The consequences are just beginning to be visible. Premarital sex is no longer rare. Living together is no longer scandalous. The shotgun wedding — marry her because she's pregnant — is becoming outdated.
...
- Living together: Still rare — only 1.1% of couples — but rising fast. The stigma is fading.
...
Three words that would have been impossible to understand for Samuel Lowe. For Amos before him. A relationship isn't supposed to be "fun." It's supposed to be *binding*.
...
Tommy doesn't care about the divorce. Doesn't care about Dylan. In 1976, this is no longer a deal-breaker. The stigma is gone.
...
Karen is pregnant. Not with Dylan's sibling — that would be simple. She's pregnant with Tommy's child. They've been living together for two years, using birth control now and then, and now here they are.
...
Tommy holds him in the hospital — a different hospital than where he was born, in a different city, surrounded by people he doesn't know — and feels... something. Not the weight of the family line. Not the chain.
...
**Thomas (c. 1974)** comes of age in a world that feels suddenly different. Authority is questioned, institutions feel hollow, and moral claims are framed as mere preferences. To Thomas, the world changed all at once; to his parents, it feels impossible to explain. This is the subjective experience of a **system undergoing a phase transition** — like water suddenly turning to steam when it hits the boiling point.

In this era, multiple limits are removed in rapid succession, crossing the critical threshold. **Faithfulness** is undermined by no-fault divorce; **self-control** dissolves with the removal of consequences; **goodness** separates from enforcement; **patience** collapses under immediacy. This is not erosion; it is **structural removal** — like pulling the supports out from under a bridge all at once.

From a physics perspective, this is the moment the system crosses **Pc** (the critical point). Constraint pressure falls below the threshold, and social coherence collapses in a sudden jump. The key signature is **speed**: decline is no longer gradual, and the change feels abrupt and total.

Thomas inherits a world where rules feel optional and freedom feels compulsory. He is told he is "free," but he experiences this as a burden, because internal constraints must replace external ones, and the system has not prepared him for that. Thomas shows the crossing: after this point, the system has entered a new phase with new rules. What follows is entropy — the slow, steady drift toward disorder.
