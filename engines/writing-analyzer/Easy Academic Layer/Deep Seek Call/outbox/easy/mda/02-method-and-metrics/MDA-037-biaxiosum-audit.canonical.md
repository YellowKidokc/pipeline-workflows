...
---
claims:
  - "The American Founders built their government on openly admitted biases (self-evident truths), not claimed objectivity."
  - "Modern institutions (academia, government) claim neutrality but have a Biaxiosum score of zero, hiding their biases behind policy and objectivity."
  - "The Bias Blind Spot causes experts to see bias in others twice as often as in themselves, making claimed objectivity dangerous."
  - "David Hull's principle states science requires different biases to self-correct, but modern academia violates this with ideological homogeneity (e.g., 108:0 Democrat-to-Republican ratio in sociology)."
  - "The modern state has inverted every Founding axiom: rights are now permissions, government defines rather than secures rights, and revolution is criminalized as terrorism."
domains:
  History/Political Theory: 35
  Psychology/Cognitive Bias: 20
...
I need you to know that before you read another word. I came into this with my heart first, my intuition leading, my faith intact. I believe in God. I believe consciousness (your inner awareness, the fact that you experience things) matters. I believe there's meaning woven into the fabric of everything.

I didn't hide that. I'm not hiding it now.

I walked through this framework — every axiom (a starting assumption you don't prove), every equation, every claim — and I came out the other side. Not broken. Not disillusioned. **Stronger.** More myself than when I started.
...
- Physicalist (same thing, different label)
- Agnostic (you don't know if God exists)
- Atheist (you believe God doesn't exist)
- Christian
- Skeptic
- Seeker
- Something else?
...
You don't get to shapeshift mid-argument. You don't get to be a materialist when you're attacking my metaphysics (my beliefs about what's real) and then suddenly "open-minded" when I ask what your framework explains. You don't get to deny consciousness as fundamental in Axiom 12 and then smuggle it back in when it's convenient in Axiom 47.
...
That's **Biaxiosum** (pronounced bee-ax-ee-OH-sum). That's naming your lens — your bias, your starting point — before you look through it. The Founders walked up to the table and said: "Here's who we are. Here's what we believe. Here's the ground we're standing on. Now let's build."
...
| Rights are unalienable (can't be taken away) | Rights are permissions (can be revoked) |
