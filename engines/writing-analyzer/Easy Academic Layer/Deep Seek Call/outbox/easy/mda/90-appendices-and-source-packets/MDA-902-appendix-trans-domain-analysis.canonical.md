...
---
claims:
  - "American civilizational coherence, measured by the Coherence Factor (χ), has declined from 0.85 in 1900 to 0.27 in 2024, a 68% drop."
  - "The collapse followed an invariant cascade across four civilizations (Rome, Weimar Germany, Soviet Union, USA): Semantic → Familial → Institutional → Economic, with zero violations."
  - "The Amish, who maintain high constraint pressure, have a coherence factor of 0.88, a 330% gap compared to mainstream America's 0.27, proving constraint is load-bearing."
  - "The phase transition occurred between 1968 and 1973, when three uncorrelated systems (family, economy, truth) broke simultaneously due to the removal of external constraints."
  - "Restoration must follow the same sequence as collapse: start with language (semantic layer), then family, then institutions. Legislation must come last, not first."
  - "The model is falsifiable with four kill conditions; zero have been triggered."
domains:
  Physics: 10
  Theology: 20
  Mathematics: 15
...
This equation says: tomorrow's coherence equals today's coherence, minus a small natural decay (like rust), plus any external input of coherence from outside the system.
...
This equation fits the coherence data over time. It says coherence decays exponentially (like a radioactive substance), plus there's a repeating wave pattern on top of it, plus a constant baseline.
