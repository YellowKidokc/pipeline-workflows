...
---
claims:
  - "Both scientific naturalism and biblical theism rest on unprovable foundational axioms (assumptions) that cannot be validated by their own methods."
  - "Science requires ten untestable presuppositions (like the existence of the external world and the uniformity of nature) before it can even begin an experiment."
  - "The question is not 'faith versus evidence' but which foundational commitment better explains what we actually observe in reality."
domains:
...
- Sources: Hume's Problem of Induction (1739), Gauch's 10 Presuppositions of Science, Calvin's Self-Authentication of Scripture, Hebrews 6:13.
...
Science uses induction to prove that induction works. Induction is the idea that because something happened many times in the past, it will happen again in the future. The scientific method has been successful in the past, therefore it will be reliable in the future — which is itself an inductive argument. David Hume pointed this out three centuries ago and nobody's solved it since.
