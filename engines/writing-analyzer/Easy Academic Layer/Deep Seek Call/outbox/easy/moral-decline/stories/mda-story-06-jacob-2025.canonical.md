...
---
claims:
  - "Social isolation is as deadly as smoking 15 cigarettes a day, with 12% of adults reporting no close friends (up from 3% in 1990), proving that technology-driven connection without commitment has caused a loneliness epidemic."
  - "The collapse of birth rates to 1.6 children per woman in America (lowest in history) and the rise of AI companions (30+ million users) show that infinite options on dating apps lead to exhaustion and emptiness, not fulfillment."
  - "The four-generation family wisdom 'Find a good woman. Work. Stay' is not obsolete but more essential than ever, because staying must now be a voluntary choice rather than an external constraint."
  - "Rebuilding social coherence requires creating 'local coherence bubbles' — physical spaces like churches or discussion groups where people show up regularly, without optimization or algorithms."
  - "The virtues of patience, faithfulness, and love that were once produced by social structure must now be chosen daily against the current of infinite digital distractions."
  - "Jake's story demonstrates that attentional reorientation — turning off notifications, sitting in silence, being present in a physical place — is the precondition for forming real human connections."
  - "The chain of wisdom can continue across generations even without biological children, as Tyler names his son William after Jake's grandfather, passing the same four-word formula to a sixth generation."
domains:
  Sociology: 30
...
The Surgeon General declared it in 2023. Loneliness, he said, is as deadly as smoking fifteen cigarettes a day. Social isolation increases the risk of early death by 26%. Americans have fewer friends than ever before. Fewer marriages. Fewer children. Fewer connections of any kind.
