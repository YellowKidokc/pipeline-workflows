...
---
claims:
  - "The period around 1950 represents the peak of American social coherence, with all nine domains of moral and institutional health near their maximum values."
  - "Television was the fastest-adopted technology in history, going from 9% to 87% of households between 1950 and 1960, and it fundamentally changed how Americans saw themselves by replacing local neighbors with national standards."
  - "William Lowe's generation made the central error of mistaking inherited social stability for proof that constraints were unnecessary, which granted moral permission for the dismantling that followed."
  - "The system's coherence peaked right before it collapsed because it was in a 'critically poised state' where small perturbations had outsized effects."
  - "By 1968, the invisible architecture of constraints that held American society together was about to be removed one by one, leaving only choice with no structure to guide it."
domains:
  History/Culture: 35
  Sociology: 25
  Media Studies: 15
...
The war is over. The Depression is a memory. The United States stands astride the world like a giant — half the planet's manufacturing output, the only nuclear power, the arsenal of democracy now retooled for peace.
...
The middle class is expanding like never before. A factory worker with a high school education can buy a house, a car, a refrigerator, a washing machine. He can raise three kids, send them to college, retire with a pension. This is not a dream. This is reality. This is 1950.
