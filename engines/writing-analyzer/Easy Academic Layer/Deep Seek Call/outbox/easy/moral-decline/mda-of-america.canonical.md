...
---
claims:
  - "American civilizational coherence (χ) declined from 0.85 in 1900 to 0.27 in 2024, a 68% drop, measured across nine domains including family, trust, and shared meaning."
  - "The critical phase transition occurred between 1968 and 1973, when three uncorrelated systems (family, economy, truth) broke simultaneously due to the removal of external constraints like covenant marriage, the gold standard, and institutional authority."
  - "The invariant cascade of collapse follows a fixed sequence: semantic (language) → familial → institutional → economic, validated across four civilizations (Rome, Weimar Germany, Soviet Union, United States) with zero violations."
  - "The Amish, who maintain high constraint pressure, show a 330% coherence advantage over mainstream America (χ = 0.88 vs. 0.27), outperforming on every metric including divorce, depression, and debt."
  - "Restoration must follow the same sequence as collapse, starting with language and narrative (not law or politics), as demonstrated by Victorian Britain, the Second Great Awakening, and Meiji Japan."
  - "The model is falsifiable with four kill conditions, none triggered; the corrected p-value is 0.003 (K-S test), meaning a 1 in 300 chance of the pattern being random."
  - "America crossed the self-correction threshold (χ ≈ 0.35) around 2008, below which institutions cannot reform themselves because shared meaning has dissolved."
domains:
  Physics: 10
  Theology: 25
  Mathematics: 15
...
This equation means: tomorrow's coherence equals today's coherence, minus a small natural decay (like rust), plus any external input that adds coherence from outside the system.
...
1.0 0.75 0.50 0.25 0.0 THRESHOLD 0.35 1940 1958 1968 1973 1980 1990 2000 2010 2024 0.91 0.89 0.72 0.59 0.49 0.40 0.34 0.27 0.20 PHASE TRANSITION Source: MASTER_DATASHEET.csv — Census, Gallup, FBI UCR, FRED, CDC, College Board, Google Ngram
...
6. The model is falsifiable. Four kill conditions specified. Zero triggered.
...
This equation means: coherence over time follows a natural decay pattern (like a dying battery), plus a wave pattern (like seasonal ups and downs), plus a constant baseline.
