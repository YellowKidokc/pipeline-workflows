...
---
claims:
  - "The early Christian church grew as a scale-free network, matching the Barabasi-Albert preferential attachment model where new converts disproportionately connect to already-large churches."
  - "The church survived Roman persecution that targeted leaders because it had already grown past its initial hubs, exactly as network resilience theory predicts for scale-free networks."
  - "Jesus' statement 'To those who have, more will be given' (Matthew 25:29) is a verbal formulation of preferential attachment, stated 1,950 years before Barabasi."
  - "Cross-cultural missionaries function as 'weak ties' (Granovetter's theory) that connect disconnected clusters, enabling gospel diffusion that strong ties alone could not achieve."
  - "The gift distribution in 1 Corinthians 12 follows a power-law pattern, not a uniform distribution — rare high-connectivity gifts (apostle, prophet) are held by few, common gifts by many."
  - "Romans 16 provides a recoverable social network edge list that can be tested against network formation models."
  - "Organically grown churches (scale-free) are more resilient to persecution than institutionally structured churches, as seen in underground Chinese churches versus state-aligned churches."
domains:
  Network Science: 35
  Theology: 30
  Mathematics: 15
...
# ISO-031: Network Science and Church Structure
...
**Domain B:** Christian Theology — New Testament Church Structure, Growth, Spiritual Gifts, Leadership, Persecution Response

**Concept A:** Networks show small-world properties (short paths between nodes, high clustering), scale-free degree distributions (power-law, with hubs), preferential attachment growth (new nodes connect to well-connected nodes), and different types of resilience (strong against random failure, weak against targeted hub attack)

**Concept B:** The New Testament church spread fast through short relational paths, clustered house-church communities, apostolic hubs connecting otherwise disconnected groups, growth patterns where established churches attract new converts more, and resilience under persecution that targets leaders
...
This means: The chance that a new node connects to an existing node follows a power law. Most nodes have few connections, a few nodes have many.

The probability that a new node connects to an existing node i is proportional to the degree k_i of node i:

Pi(i) = k_i / Sum(k_j)

This means: A new node is more likely to connect to a node that already has many connections. Like the slope of a hill — you don't get pushed, the ground itself tilts so you naturally move toward the bottom. Grace changes the shape of the ground under your feet.
...
This means: In a small-world network, you can get from any node to any other node in very few steps. And nodes that are connected to each other tend to form tight clusters.
...
This means: If you randomly remove nodes from a scale-free network, it mostly stays connected. But if you remove the most connected hubs on purpose, the network falls apart fast.
...
This means: Like a radio signal through static — the clearer the channel, the more of the message gets through. Sin is the static. Truth is the signal. Weak ties are the channels that carry new information between groups that don't normally talk to each other.
...
This means: New Christians were more likely to join churches that were already big and well-known. The bigger the church, the more new people it attracted.
...
This means: The message traveled from one end of the Roman Empire to the other in about 30 years through a short chain of people who knew each other. Like two people watching the same car crash from different street corners — what you see depends on where you're standing, but the crash still happened.
...
This means: Within each house church, everyone knew everyone else. But the connections between different house churches were carried by traveling apostles and people who carried letters.
...
This means: When Rome killed the church leaders, the church didn't die. The message had already spread to enough other people that the leaders weren't needed anymore to keep it going.
