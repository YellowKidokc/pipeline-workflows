...
---
claims:
  - "Addiction and sin bondage share the same structural pattern: both are progressive enslavements in closed systems that cannot self-rescue."
  - "The mathematical forms dR/dt < 0 (receptor sensitivity decline) and dM/dt < 0 (moral sensitivity decline) are topologically identical — both describe monotonic degradation without external intervention."
  - "AA's Twelve Steps independently discovered the Terminus Sui structure (Step 1: powerlessness) and grace coupling (Step 2: higher power), providing convergent evidence that recovery requires external input."
  - "The ten correspondences (tolerance/desensitization, allostatic load/moral damage, withdrawal/repentance pain, neural entrenchment/habit formation, self-rescue impossibility, external intervention, relapse/backsliding, cross-tolerance/sin clusters, dopamine hijacking/idolatry, recovery community/ecclesiology) are specific to addiction-bondage, not generic to all neuroscience."
  - "The mapping is falsifiable: if addicts can self-rescue by willpower alone, or if solitary recovery works as well as community-supported recovery, the isomorphism fails."
  - "Neuroscience constrains theology: any model claiming instantaneous permanent transformation with zero residual vulnerability contradicts neuroplasticity evidence that old pathways persist."
  - "Theology predicts addiction treatment will fail if it relies solely on pharmacology without community, ignores the redirected-desire structure, or expects recovery without genuine suffering."
domains:
  Neuroscience: 30
  Theology: 30
  Mathematics: 10
...
**Concept A:** Addiction is a process where the brain's reward system slowly changes around a drug or behavior. You need more to get the same effect (tolerance). Your body builds up damage from staying in a stressed state (allostatic load). When you stop, you suffer (withdrawal). Recovery needs help from outside — you can't just use willpower, because the part of your brain that decides to quit is the same part the addiction has taken over.

**Concept B:** Sin bondage is a process where a person's moral sense slowly changes around a sinful pattern. You feel less guilt over time (desensitization). Your character gets damaged (hardening). When you try to stop, it hurts (repentance). Freedom needs grace from outside — you can't just try harder, because the will that must choose freedom is the same will that's been enslaved. Romans 7:15 says it: "I do not do what I want, but I do the very thing I hate."
...
*This equation says: over time, the brain's sensitivity to natural rewards keeps going down. It never goes back up on its own.*
...
*This equation says: the total damage to your body is the sum of all stress minus all recovery, added up over time. If stress keeps beating recovery, damage piles up.*
...
*This equation says: over time, your conscience gets less sensitive. It never gets more sensitive on its own.*
...
*This equation says: the total moral damage is the sum of all sin minus all grace received, added up over time. If sin keeps beating grace, damage piles up.*
