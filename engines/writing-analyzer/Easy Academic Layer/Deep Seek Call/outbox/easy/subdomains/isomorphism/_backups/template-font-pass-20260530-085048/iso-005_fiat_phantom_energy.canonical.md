...
---
claims:
  - "Fiat currency (money not backed by gold) violates the First Law of Thermodynamics because it creates money from nothing, which is like creating energy from nothing — both produce waste instead of value."
  - "The 1971 Nixon Shock, which ended the gold standard, was a phase transition that removed the conservation constraint on money, leading to measurable inflation, inequality, and debt increases."
  - "Every fiat currency in history has eventually failed, with an average lifespan of about 27 years, because the conservation violation accumulates waste heat (inflation) that destroys the system."
  - "Fiat currency is not just bad policy — it is a structural violation of divine moral order, as shown by biblical prohibitions against false measures (Proverbs 11:1) and theft (Exodus 20:15)."
  - "The Cantillon Effect — where those closest to money creation benefit first — is the economic equivalent of local cooling at the cost of global heating, matching thermodynamic entropy increase."
  - "No fiat currency can maintain purchasing power indefinitely because the conservation violation requires exponential growth to service debt, which is thermodynamically impossible."
  - "The mapping between physics and economics is a well-structured analogy, not a true isomorphism, because energy conservation is a fundamental law while monetary conservation was an institutional choice that could be overridden."
domains:
  Physics: 30
  Economics: 25
  Theology: 20
...
**Claims Derived:**
- ^C1 — Fiat currency as thermodynamic fraud

**Evidence Anchored:**
- ^E1 — Historical Fiat Currency Failures

**Bridges Claimed:**
- ^B1 — Structural Mapping between Physics and Economics
...
### A1 — Axiom: Conservation of Energy
...
### C1 — Claim: Fiat currency as thermodynamic fraud

**Source nodes:** Conservation of Energy
**Chain:** Conservation violation → systemic disorder
**Weakest link:** Institutional trust
**If breaks:** Mapping fails
**Vulnerability:** N/A
**Unlocks:** N/A

### E1 — Evidence: Historical Fiat Currency Failures

**Claim being grounded:** Fiat currency as thermodynamic fraud
**Data cited:** Roman denarius, Continental Dollar, Assignat, Reichsmark, Zimbabwe dollar
**Supports full or weaker version:** Full
**What kills empirically:** Stable fiat currency lasting over 100 years
**Confidence:** High
**Vulnerability:** N/A
**Unlocks:** N/A

### B1 — Relationship: Structural Mapping between Physics and Economics

**Domain A:** Physics
**Domain B:** Economics/Theology
**Isomorphism:** Conservation violation → systemic heating
**Constrains predictions in both domains:** Predicts degradation in fiat systems
**What would make this just a metaphor:** Lack of structural parallels
**Vulnerability:** Asymmetry in ontological status
**Unlocks:** N/A
...
This means: In a closed system, the total amount of energy stays the same. You can't create energy from nothing.
