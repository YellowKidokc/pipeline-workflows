@echo off
:: ============================================================
::  DeepSeek Direct-Call  —  Double-click this file to run
:: ============================================================
title DeepSeek Direct-Call
cd /d "%~dp0"

echo.
echo ============================================================
echo   DeepSeek Direct-Call
echo ============================================================
echo.
echo   1.  Edit config.txt   — paste your DeepSeek API key
