:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {.max-w-3xl role="main"}
::: {#part-i .section-divider}
[Part I]{.font-display .font-bold .text-sm .text-teal .tracking-widest .uppercase .whitespace-nowrap}
:::

::::: {#constraint-argument .section .mb-16 .fade-in}
## THE CONSTRAINT ARGUMENT {#the-constraint-argument .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
::::: {#relational-descriptions .section .mb-16 .fade-in}
### The Relational Limit of Physical Description {#the-relational-limit-of-physical-description .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
::::: {#moral-experience .section .mb-16 .fade-in}
### Moral Experience as the Test Case {#moral-experience-as-the-test-case .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
::::::::::::: {#three-options .section .mb-16 .fade-in}
### The Three Options {#the-three-options .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-8}
...
::: {}
#### Deny the Hard Problem {#deny-the-hard-problem .font-sans .font-bold .text-text-primary .text-lg .mb-2}
...
::: {}
#### Provide the Reduction {#provide-the-reduction .font-sans .font-bold .text-text-primary .text-lg .mb-2}
...
::::: {.category-card style="border-color: #14b8a6;"}
:::: {.flex .items-start .gap-4}
[3]{.section-badge style="background: #0d9488;"}

::: {}
#### Accept a New Primitive {#accept-a-new-primitive .font-sans .font-bold .text-teal .text-lg .mb-2}
...
::::: {#logos-field .section .mb-16 .fade-in}
### The Logos Field {#the-logos-field .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}

::: prose-body
The framework does not assert that this primitive is God. That is the conclusion the argument reaches, not the premise it begins with. The argument begins here: if a non-relational primitive is required, then the Logos field is its candidate --- a substrate whose states are intrinsically coherent rather than relationally described, whose conservation law is [∇·χ = 0]{.font-mono .text-teal}, and whose operation is visible in the stability of physical law, the precision of the cosmological constants, the structure of the double-slit experiment, and the universal human recognition that right and wrong are not preferences but facts. The argument is ontological before it is theological. Theology is where the argument arrives when the constraints are followed to their conclusion without flinching.
:::
...
::::::: {#adversarial-notes .section .mb-16 .fade-in}
### Adversarial Notes {.font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
:::::: space-y-6
::: adversarial-block
#### Objection 1: \"357 failures\" proves immaturity, not non-materialism. {#objection-1-357-failures-proves-immaturity-not-non-materialism. .font-sans .font-bold .text-accent-warm .text-base .mb-3 .mt-2}
...
::: adversarial-block
#### Objection 2: Moral consciousness is modelable as emergent social cognition. {#objection-2-moral-consciousness-is-modelable-as-emergent-social-cognition. .font-sans .font-bold .text-accent-warm .text-base .mb-3 .mt-2}
...
::: adversarial-block
#### Objection 3: The scorecard criteria may be question-begging. {#objection-3-the-scorecard-criteria-may-be-question-begging. .font-sans .font-bold .text-accent-warm .text-base .mb-3 .mt-2}
...
[Part II]{.font-display .font-bold .text-sm .text-teal .tracking-widest .uppercase .whitespace-nowrap}
:::

::::::::::::::::::::: {#hard-problem .section .mb-16 .fade-in}
## THE HARD PROBLEM {#the-hard-problem .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
:::::: {.rounded-xl .overflow-hidden .border .border-dark-border .my-8}
::::: comparison-strip
::: left-col
#### The \"Easy\" Problems {#the-easy-problems .font-sans .font-bold .text-teal .text-base .mb-3}
...
::: right-col
#### The \"Hard\" Problem {#the-hard-problem-1 .font-sans .font-bold .text-accent-warm .text-base .mb-3}
...
#### Intellectual Lineage {#intellectual-lineage .font-display .font-bold .text-xl .text-text-primary .mt-10 .mb-5}

::::::::::::: {.relative .pl-8 .border-l-2 .border-teal/30 .space-y-8 .mb-8}
:::: relative
::: {.absolute .-left-[2.55rem] .top-1 .w-5 .h-5 .bg-teal .rounded-full .border-4 .border-dark}
:::
...
:::::::::: {#why-357 .section .mb-16 .fade-in}
## WHY 357 THEORIES? {#why-357-theories .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
#### The 5 Fundamental Binary Questions {#the-5-fundamental-binary-questions .font-display .font-bold .text-xl .text-text-primary .mt-10 .mb-5}
...
:::::::::::::::::::::::::::::::::: {#ten-categories .section .mb-16 .fade-in}
## THE 10 CATEGORIES {#the-10-categories .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
[1]{.section-badge .text-lg}

::: {}
#### Materialism {#materialism .font-display .font-bold .text-xl .text-text-primary}

[161 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[2]{.section-badge .text-lg}

::: {}
#### Non-Reductive Physicalism {#non-reductive-physicalism .font-display .font-bold .text-xl .text-text-primary}

[11 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[3]{.section-badge .text-lg}

::: {}
#### Quantum & Dimensions {#quantum-dimensions .font-display .font-bold .text-xl .text-text-primary}

[25 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[4]{.section-badge .text-lg}

::: {}
#### Information {#information .font-display .font-bold .text-xl .text-text-primary}

[12 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[5]{.section-badge .text-lg}

::: {}
#### Panpsychism {#panpsychism .font-display .font-bold .text-xl .text-text-primary}

[17 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[6]{.section-badge .text-lg}

::: {}
#### Monism {#monism .font-display .font-bold .text-xl .text-text-primary}

[13 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[7]{.section-badge .text-lg}

::: {}
#### Dualism {#dualism .font-display .font-bold .text-xl .text-text-primary}

[30 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[8]{.section-badge .text-lg}

::: {}
#### Idealism {#idealism .font-display .font-bold .text-xl .text-text-primary}
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[9]{.section-badge .text-lg}

::: {}
#### Anomalous & Altered States {#anomalous-altered-states .font-display .font-bold .text-xl .text-text-primary}

[27 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: category-card
:::: {.flex .items-center .gap-3 .mb-4}
[10]{.section-badge .text-lg}

::: {}
#### Challenge {#challenge .font-display .font-bold .text-xl .text-text-primary}

[18 Theories]{.font-sans .text-xs .font-semibold .text-teal .bg-teal/10 .px-2 .py-0.5 .rounded}
:::
::::
...
::::: {#scorecard .section .mb-16 .fade-in}
## THE SCORECARD {#the-scorecard .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}

How 357 Theories Measure Against 9 Criteria

::: {.rounded-2xl .shadow-lg .border .border-dark-border .p-4 .md:p-6 .overflow-x-auto style="background: #0a0a0a;"}
...
::: {.mt-6 .p-4 .rounded-lg .border style="background: rgba(20,184,166,0.05); border-color: rgba(20,184,166,0.15);"}
...
:::::::::::::::::::: {#structural-patterns .section .mb-16 .fade-in}
## STRUCTURAL PATTERNS {.font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}

Across All 357

:::: {#measurement-problem .mb-12}
### The Measurement Problem and the Formalism Gap {#the-measurement-problem-and-the-formalism-gap .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
::::::::::: {#qualia-wall .mb-12}
### The Qualia Wall: Same Wall, Different Disguises {#the-qualia-wall-same-wall-different-disguises .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
::::::: {.space-y-3 .my-6}
::: {.flex .items-start .gap-3 .p-4 .rounded-lg .border-l-3 .border-teal style="background: #111111;"}
...
:::: {#binding-problem .mb-12}
### The Binding Problem and the Unity of Consciousness {#the-binding-problem-and-the-unity-of-consciousness .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
:::: {#observer-problem .mb-12}
### The Observer Problem: Explaining vs. Grounding {#the-observer-problem-explaining-vs.-grounding .font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
:::: {#consciousness-of-what .mb-12}
### Consciousness of What? {.font-display .font-bold .text-2xl .md:text-3xl .text-text-primary .mb-6}
...
::::::::::::::: {#hidden-consensus .section .mb-16 .fade-in}
## WHAT THEY ALL SHARE {#what-they-all-share .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
::::::::::::: space-y-4
:::: {.flex .items-start .gap-4 .p-5 .rounded-xl .border style="background: rgba(20,184,166,0.03); border-color: rgba(20,184,166,0.15);"}
[1]{.section-badge .flex-shrink-0}

::: {}
#### Consciousness is real {#consciousness-is-real .font-sans .font-bold .text-text-primary .mb-1}
...
:::: {.flex .items-start .gap-4 .p-5 .rounded-xl .border style="background: rgba(20,184,166,0.03); border-color: rgba(20,184,166,0.15);"}
[2]{.section-badge .flex-shrink-0}

::: {}
#### It is correlated with physical processes {#it-is-correlated-with-physical-processes .font-sans .font-bold .text-text-primary .mb-1}
...
:::: {.flex .items-start .gap-4 .p-5 .rounded-xl .border style="background: rgba(20,184,166,0.03); border-color: rgba(20,184,166,0.15);"}
[3]{.section-badge .flex-shrink-0}

::: {}
#### The easy problems are tractable {#the-easy-problems-are-tractable .font-sans .font-bold .text-text-primary .mb-1}
...
:::: {.flex .items-start .gap-4 .p-5 .rounded-xl .border style="background: rgba(20,184,166,0.03); border-color: rgba(20,184,166,0.15);"}
[4]{.section-badge .flex-shrink-0}

::: {}
#### Something about consciousness resists standard explanation {#something-about-consciousness-resists-standard-explanation .font-sans .font-bold .text-text-primary .mb-1}
...
:::: {.flex .items-start .gap-4 .p-5 .rounded-xl .border style="background: rgba(20,184,166,0.03); border-color: rgba(20,184,166,0.15);"}
[5]{.section-badge .flex-shrink-0}

::: {}
#### No theory has solved the hard problem {#no-theory-has-solved-the-hard-problem .font-sans .font-bold .text-text-primary .mb-1}
...
:::::::::: {#blind-spots .section .mb-16 .fade-in}
## SYSTEMATIC BLIND SPOTS {#systematic-blind-spots .font-display .font-bold .text-4xl .md:text-5xl .text-text-primary .mb-2 .tracking-tight .leading-tight}
...
:::::::: space-y-8
::: {#blind-spot-1 .insight-box}
#### [I.]{.text-teal .mr-2}The Missing Causal Chain {#i.the-missing-causal-chain .font-display .font-bold .text-xl .text-text-primary .mb-3}
...
::: {#blind-spot-2 .insight-box}
#### [II.]{.text-teal .mr-2}The Problem of Moral Consciousness {#ii.the-problem-of-moral-consciousness .font-display .font-bold .text-xl .text-text-primary .mb-3}
...
::: {#blind-spot-3 .insight-box}
#### [III.]{.text-teal .mr-2}The Specific Character of Qualia {#iii.the-specific-character-of-qualia .font-display .font-bold .text-xl .text-text-primary .mb-3}
...
::: {#blind-spot-4 .insight-box}
#### [IV.]{.text-teal .mr-2}Teleology and Meaning {#iv.teleology-and-meaning .font-display .font-bold .text-xl .text-text-primary .mb-3}
...
::: {#blind-spot-5 .insight-box}
#### [V.]{.text-teal .mr-2}Integration of First-Person and Third-Person Methodologies {#v.integration-of-first-person-and-third-person-methodologies .font-display .font-bold .text-xl .text-text-primary .mb-3}
...
::: section-divider
[]{.font-display .font-bold .text-sm .text-teal .tracking-widest .uppercase .whitespace-nowrap}
:::

::: {.text-center .py-12 .mb-8}
