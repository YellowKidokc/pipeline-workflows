...
**In plain language:** A system can't even _define_ what "true" means using only its own resources. If you try, you get the Liar's Paradox — "This sentence is false." Truth requires a reference point outside itself.
...
Only Option 3 is logically coherent. And the required properties of a self-grounding terminus are precisely the classical attributes of God: necessary existence, self-existence (_aseity_), simplicity, eternality, and the ground of all being.
...
## Go Deeper
 ...
 [Moral Dictionary →](dictionary.html) [Pre-Human Math →](prehumanmath.html)
